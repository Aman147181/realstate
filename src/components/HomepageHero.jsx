...
const HomepageHero = () => {
  return (
    ...
    >
      <h1 className="text-white px-5 text-center font-medium [text-shadow:_0_1px_0_rgb(0_0_0_/_40%)] uppercase text-4xl md:text-7xl xl:text-[96px]">
      ...
      <Link href="/property">
        <button className="bg-[#ee5e00] p-6 py-4 text-xs sm:text-sm  hover:bg-orange-500 text-white transition-colors duration-250 uppercase ">
          Explore properties
        </button>
      </Link>
      <SearchComponent />
